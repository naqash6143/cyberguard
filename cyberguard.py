...
if selection=="NCA CrimeAssist":
    st.subheader("Welcome to National Crime Agency Assistant 👮‍♂️")
    ...
    st.write("Reach us via [📧](report@phishing.gov.uk) or contact [Action Fraud](🌐www.actionfraud.police.uk) /03001232040")
...
if selection=="Education Portal":
    ...
    st.write("Test Yourself [Here](https://docs.google.com/forms/d/e/1FAIpQLScSmGigCE4aKe2S7GPlJQLnhbu8TLnxi424hQA5tGWVSHrw5w/viewform?usp=dialog)")
